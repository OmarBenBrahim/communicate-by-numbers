...
export default function Login() {
  ...
  return (
    <>
      <Head>
        <title>Login - Communicate by Numbers</title>
      </Head>
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="w-full max-w-md">
          <div className="bg-white p-8 rounded-lg shadow">
            ...
            {mutation.isError && <div className="mt-4 p-3 bg-red-50 text-red-700 rounded">{(mutation.error as any)?.response?.data?.error || 'Login failed'}</div>}
